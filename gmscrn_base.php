...
if ($mode == 'proc'){
	...
	echo "<font style=\"font-weight: Bold; font-size: 8pt\">玩家名稱:</font><br><span style=\"color: $Player[color]; font-weight: Bold; width: 95%;\">&nbsp; $Player[gamename] &nbsp;</span>";
	echo "<br><font style=\"font-weight: Bold; font-size: 8pt\">所屬組織:</font><br><span style=\"width: 95%\"><font style=\"color: $Pl_Org[color]; font-weight: Bold;\">&nbsp; $Pl_Org[name]</font>";
	if ($RightsTitle)
	echo "<font style=\"color: yellow;font-weight: Bold;\"> &nbsp;$RightsTitle</font>";
	echo "&nbsp;($Pl_Rank) &nbsp;";
	echo "</span>";
	echo "<br><font style=\"font-weight: Bold; font-size: 8pt\">組織宣言:</font><br><span style=\"width: 95%\"><font style=\"color: $Pl_Org[color]; font-weight: Bold;word-break:break-all\">&nbsp; $Pl_Org[pose]</font></span>";
	echo "<br><font style=\"font-weight: Bold; font-size: 8pt\">所在地區:</font><br><span style=\"width: 95%;$WarColor\"><font style=\"font-weight: Bold;\">&nbsp; $Player[coordinates] ($AreaLandForm)</font> (<font style=\"color: $AreaOrg[color]\">".$AreaOrg['name']."</font>) &nbsp;</span>";
	echo "</td>";
	echo "</tr>";
	...
	echo "<td style=\"background-image: url('$General_Image_Dir/neo/rt_tab_bg.jpg');\" colspan=3 width=200>";
	echo "<span style=\"background-color:  ". $Gen['color'] ."\">&nbsp;<b>邀請信</b>&nbsp;</span><br>";
	echo "$Gen[request]";
	...
	if($Operation_Details){
		...
		echo "<b color=FEFEFE>出擊通知書 - 組織有任務交給您了</span>";
		echo "</td><td width=13 style=\"background-image: url('$General_Image_Dir/neo/btn_neo_r.gif');\">&nbsp;</td></tr>";
		echo "<tr height=109 style=\"padding-left: 10px;padding-top: 3px\" valign=top>";
		echo "<td style=\"background-image: url('$General_Image_Dir/neo/rt_tab_bg.jpg');\" colspan=3 width=200>";
	...
	if ($Otp_TellTime){
		...
		echo "<table align=center border=\"0\" cellpadding=\"0\" cellspacing=\"0\" style=\"border-collapse: collapse\" width=200>";
	...
	echo "</tr><tr><td colspan=2 style=\"background-Image: url('$General_Image_Dir/neo/table_bg.gif'); border:solid #707070 1px; border-top: 0px;\" valign=top>";
		...
		echo "<table align=center border=\"0\" cellpadding=\"0\" cellspacing=\"0\" style=\"border-collapse: collapse;\" width=\"300\">";
		echo "<tr style=\"font-weight: Bold;\"><td colspan=4>$Ms[msname]　　　　　　　　　　　機體等級: $Player[mslv]</td></tr>";
		...
		echo "<td width=60 align=center>攻擊</td>";
		...
		echo "</span></td></tr>";
		echo "<tr style=\"font-weight: Bold;\">";
		echo "<td width=60 align=center>防禦</td>";
		...
		echo "</tr>";
		echo "<tr style=\"font-weight: Bold;\">";
		echo "<td width=60 align=center>迴避</td>";
		...
		echo "</tr>";
		echo "<tr style=\"font-weight: Bold;\">";
		echo "<td width=60 align=center>命中</td>";
	...
	echo "</tr><tr><td height=180 colspan=2 style=\"background-Image: url('$General_Image_Dir/neo/table_bg.gif');\" valign=top>";
		...
		if(!$Game['reset']){
			echo "<font style=\"color: red\" onclick=\"act.action='reset.php?action=stats';act.actionb.value='A';act.target='$SecTarget';act.submit();\">重置點數<font></td>";
		}
		echo "<td align=left>積分:<span id=pl_vpoints>$Player[v_points]</span> <br> 次數:<span id=pl_victories>$Player[victory]</span></td>";
		echo "</tr>";
		...
		echo "<tr><td colspan=4 align=center>";
			echo "<table align=center border=\"0\" cellpadding=\"0\" cellspacing=\"0\" style=\"border-collapse: collapse\" width=\"300\">";
			echo "<tr style=\"font-weight: Bold;\">";
			echo "<td width=75 align=center>攻擊</td>";
			...
			echo "</tr>";
			echo "<tr style=\"font-weight: Bold;\">";
			echo "<td width=75 align=center>防禦</td>";
			...
			echo "</tr>";
			echo "<tr style=\"font-weight: Bold;\">";
			echo "<td width=75 align=center>迴避</td>";
			...
			echo "</tr>";
			echo "<tr style=\"font-weight: Bold;\">";
			echo "<td width=75 align=center>命中</td>";
	...
	echo "<table border=\"1\" cellpadding=\"0\" cellspacing=\"0\" style=\"border-collapse: collapse;\" width=\"100%\"><tr bgcolor=black>";
	echo "<td height=20 width=780 id=CiFT style=\"padding-left: 8px\">聊天室</td>";
	...
	echo "	if (h >= m_h && document.getElementById('status_now').innerHTML=='修理中')";
	echo "	{document.getElementById('status_now').innerHTML='可戰鬥';document.getElementById('status_now').style.color='#016CFE';}";
