...
elseif($mode == 'searchPlayer'){
	...
	echo "<td align=center valign=top>";
		...
		echo "</b></td>";
		echo "<td align=left>積分:".$Op->Player['v_points']." <br> 次數:".$Op->Player['victory']."</td>";
		echo "</tr>";
	...
	echo "<td align=center>";
		echo "<table align=center border=\"0\" cellpadding=\"0\" cellspacing=\"0\" style=\"border-collapse: collapse;\" width=\"300\">";
		echo "<tr style=\"font-weight: Bold;\"><td colspan=4>".$Op->MS['msname']."　　　　　　　　　機體等級: ".$Op->Player['mslv']."</td></tr>";
		...
		echo "</table>";
		echo "<br>";
		if($orgCmd && $Pl_Org[cnum] < 10) echo "<input type=button value='招募' onClick=\"document.orgForm.submit();\" $textboxStyle>";
...
elseif ($mode == 'searchOrg'){
	...
	echo "</table>";
	echo "<br><input type=submit value='回到組織列表' onClick=\"listOrg();\" $textboxStyle><input type=submit value='返回情報首頁' onClick=\"infoForm.action.value='Main'\" $textboxStyle>";
...
elseif ($mode == 'listOrg'){
	...
	echo "&nbsp;&nbsp;&nbsp; 攻擊: ".$Info['s_at']."<br>";
	echo "&nbsp;&nbsp;&nbsp; 防禦: ".$Info['s_de']."<br>";
	echo "&nbsp;&nbsp;&nbsp; 命中: ".$Info['s_ta']."<br>";
