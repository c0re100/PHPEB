...
echo "<input type=submit $BStyleB style=\"$BStyleA\" name=battle_submit id=battle_submit value='追擊目標 (3)' OnClick=\"this.style.visibility='hidden';return checkAtk();\" disabled><br>";
if(!$version){
