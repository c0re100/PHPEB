...
echo "<tr><td>名次</td><td>駕駛員名稱</td><td>所屬組織</td><td>財產總值</td><td colspan=2>所用機體</td></tr>";
...
echo "<tr><td>名次</td><td>駕駛員名稱</td><td>所屬組織</td><td>惡名值</td><td colspan=2>所用機體</td></tr>";
...
echo "<tr><td>名次</td><td>駕駛員名稱</td><td>所屬組織</td><td>名聲值</td><td colspan=2>所用機體</td></tr>";
$sqlgen  = ("SELECT fame,gamename AS game,a.username AS user,d.name AS org,msname,image FROM `".$GLOBALS['DBPrefix']."phpeb_user_general_info` a,`".$GLOBALS['DBPrefix']."phpeb_user_game_info` b,`".$GLOBALS['DBPrefix']."phpeb_sys_ms` c,`".$GLOBALS['DBPrefix']."phpeb_user_organization` d ");
$sqlgen .= ("WHERE a.username = b.username AND c.id = msuit AND d.id = organization AND `fame` > 0 AND b.isnpc=0 ");
...
echo "<tr><td>名次</td><td>駕駛員名稱</td><td>所屬組織</td><td>懸賞金</td><td colspan=2>所用機體</td></tr>";
...
echo "<tr><td>名次</td><td>駕駛員名稱</td><td>所屬組織</td><td>等級</td><td colspan=2>所用機體</td></tr>";
...
echo "<tr><td>名次</td><td>駕駛員名稱</td><td>所屬組織</td><td>裝甲</td><td colspan=2>所用機體</td></tr>";
...
echo "<tr><td>名次</td><td>駕駛員名稱</td><td>所屬組織</td><td>能源</td><td colspan=2>所用機體</td></tr>";
...
echo "<tr><td>名次</td><td>駕駛員名稱</td><td>所屬組織</td><td>勝利積分/勝利次數</td><td colspan=2>所用機體</td></tr>";
...
echo "<tr><td>名次</td><td>駕駛員名稱</td><td>所屬組織</td><td>攻擊力</td><td colspan=2>所用機體</td></tr>";
...
echo "<tr><td>名次</td><td>駕駛員名稱</td><td>所屬組織</td><td>命中</td><td colspan=2>所用機體</td></tr>";
...
echo "<tr><td>名次</td><td>駕駛員名稱</td><td>所屬組織</td><td>迴避</td><td colspan=2>所用機體</td></tr>";
...
echo "<tr><td>名次</td><td>駕駛員名稱</td><td>所屬組織</td><td>防禦</td><td colspan=2>所用機體</td></tr>";
