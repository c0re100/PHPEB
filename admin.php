...
if ($mode == 'panel') {
	...
	$requser = ("SELECT * FROM `".$GLOBALS['DBPrefix']."phpeb_user_general_info` WHERE username NOT LIKE '%NPC%' ORDER BY lastip DESC");
...
echo "</tr>";
	...
	echo "<br><input type=submit value=\"返回\" onClick=\"parent.$SecTarget.location.replace('gen_info.php')\"></p>";
	echo "</form>";
